...
'''
@File    :   coco_test.py
@Time    :   2021/05/06 16:11:33
@Author  :   Haoyu Guo 
@Version :   1.0
@Contact :   haoyuguo@usc.edu
'''
# about how to use COCO
...
import torchvision
import taivision.data.transforms as tfs
# import torchvision.models as models
from torch.autograd import Variable
from torch.utils.data import dataloader
import numpy as np
from taivision.data.coco.classification_torchvision import CocoDetection
import cv2
...
class COCOdataset(CocoDetection):
    ...
    prefix = "/home/xuel/xw/guohaoyu/taivision/data/mscoco/"
    ...
    def __init__(self, img_path=None, ann_path=None, resize_size=[800,1333],is_train = True, transform=None):
        ...
        print("Successfully uploaded, altogether "+str(len(self.ids)) + "photos")
        ...
        print("COCO data successfully uploaded and initialized.")
    ...
    def filter(self):
        ...
        for id in self.ids:
            ...
            if(abandon == True):
                ...
                ids.append(id)
        self.ids = ids
        print("After filtering, the number of left photos is：" + str(len(self.ids)))
    ...
    def getCatName(self, index):
        assert (len(index)!=0), "there's something wrong with it"
        name = []
    ...
    def collate_fn(self, data):
        ...
        assert(len(img_list)==len(bbox_list)==len(class_list)), "please check the code"
...
if __name__ == "__main__":
    dataset = COCOdataset(is_train=True)
